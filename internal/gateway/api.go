...
// GatewayAPI provides browser-accessible session CRUD endpoints.
// Authentication uses api_key query param or X-API-Key header via security.Authenticator.
...
// NewGatewayAPI creates a new GatewayAPI handler.
