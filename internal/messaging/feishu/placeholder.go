...
// placeholderGreetings are warm acknowledgements shown alongside the Get sticker.
var placeholderGreetings = []string{
	"来啦～",
	"交给我～",
	"收到，马上～",
	"好嘞！",
