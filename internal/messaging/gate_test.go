...
func TestGate_Check_DM(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Disabled", policy: PolicyDisabled, userID: "U1", allowed: false, reason: ReasonDMDisabled},
		{name: "Open", policy: PolicyOpen, userID: "U1", allowed: true},
		{name: "Allowlist_Global", policy: PolicyAllowlist, userID: "U_ADMIN", allowed: true, globalList: []string{"U_ADMIN"}},
		{name: "Allowlist_DM_Specific", policy: PolicyAllowlist, userID: "U_DM", allowed: true, dmList: []string{"U_DM"}},
		{name: "Allowlist_Denied", policy: PolicyAllowlist, userID: "U_EVIL", allowed: false, reason: ReasonNotInAllowlist, globalList: []string{"U_ADMIN"}, dmList: []string{"U_DM"}},
	}
...
func TestGate_Check_Group(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Disabled", policy: PolicyDisabled, userID: "U1", allowed: false, reason: ReasonGroupDisabled},
		{name: "Open_NoMention_NotRequired", policy: PolicyOpen, userID: "U1", allowed: true},
		{name: "Open_NoMention_Required", policy: PolicyOpen, userID: "U1", requireM: true, allowed: false, reason: ReasonNoMention},
		{name: "Open_Mention_Required", policy: PolicyOpen, userID: "U1", mentioned: true, requireM: true, allowed: true},
		{name: "Allowlist_Global", policy: PolicyAllowlist, userID: "U_ADMIN", allowed: true, globalList: []string{"U_ADMIN"}},
		{name: "Allowlist_Group_Specific", policy: PolicyAllowlist, userID: "U_GP", allowed: true, groupList: []string{"U_GP"}},
		{name: "Allowlist_Denied", policy: PolicyAllowlist, userID: "U_DM_ONLY", allowed: false, reason: ReasonNotInAllowlist, groupList: []string{"U_GP"}},
	}
