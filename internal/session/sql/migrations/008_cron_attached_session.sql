...
INSERT INTO cron_jobs_old SELECT * FROM cron_jobs;

UPDATE cron_jobs_old SET payload_kind = 'agent_turn' WHERE payload_kind = 'isolated_session';

DROP TABLE cron_jobs;

ALTER TABLE cron_jobs_old RENAME TO cron_jobs;
