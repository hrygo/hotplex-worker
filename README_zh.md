...
| 领域         | 指南                                                                                                                                                                                                                                                      |
| :----------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **入门指南** | [快速上手](docs/User-Manual.md) · [Slack 接入](docs/channels/slack/slack-integration-guide_zh.md) · [飞书接入](docs/channels/feishu/feishu-integration-guide_zh.md) · [技术参考手册](docs/Reference-Manual.md) · [产品白皮书](docs/Product-Whitepaper.md) |
